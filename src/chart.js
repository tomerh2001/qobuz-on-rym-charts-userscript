export const CHART_ITEM_SELECTOR = '.page_charts_section_charts_item.object_release';
...
export function formatStatusText(summary) {
...
export function applyQobuzFilter(doc = document) {
